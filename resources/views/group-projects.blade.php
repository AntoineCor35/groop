            ...
            <div class="flex flex-col md:flex-row gap-6">
                ...
                <div class="w-full md:w-3/4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        @forelse ($group->projects as $project)
                            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                                <div class="p-4">
                                    ...
                                    <div
                                        class="aspect-video bg-gray-100 dark:bg-gray-700 rounded-lg mb-3 overflow-hidden">
                                        @if ($project->cover)
                        ...
                        @empty
                            <div
                                class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg col-span-full">
                                <div class="p-6 text-center">
                                    <p class="text-gray-500 dark:text-gray-400">Aucun projet disponible pour ce groupe.
                                    </p>
